...
$sqllibros = "SELECT p.id, p.nombre, p.descripcion, g.nombre AS genero FROM libro AS p
...
<body class="d-flex flex-column h-100">
    ...
    <div class="container py-3">
        ...
        <div class="row justify-content-end">
            <div class="col-auto">
                <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#nuevoModal"><i class="fa-solid fa-circle-plus"></i> Agregar Pelicula</a>
            </div>
        </div>
    ...
    <script>
        ...
        nuevoModal.addEventListener('hide.bs.modal', event => {
            ...
            nuevoModal.querySelector('.modal-body #portada').value = ""
        })
        ...
        editaModal.addEventListener('hide.bs.modal', event => {
            ...
            editaModal.querySelector('.modal-body #img_portada').value = ""
            editaModal.querySelector('.modal-body #portada').value = ""
        })
        ...
        editaModal.addEventListener('shown.bs.modal', event => {
            ...
            let portada = editaModal.querySelector('.modal-body #img_portada')
